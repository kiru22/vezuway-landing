...
import { X, AlertCircle, Zap, Frown } from "lucide-react";

const problems = [
  {
    title: "Простої транспорту",
    description: "Втрачений прибуток, через не прогнозований дохід",
    icon: AlertCircle,
    delay: 0
  },
  {
    title: "Хаос у чатах",
    description: "Сотні повідомлень у Viber та Telegram які неможливо відфільтрувати.",
    icon: Zap,
    delay: 0.1
  },
  {
    title: "Паперовий облік",
    description: "Загублені записи про доходи та паперові списки посилок.",
    icon: Frown,
    delay: 0.2
  }
];

export function ProblemsTransport() {
  return (
    <section className="py-20 lg:py-32 bg-white relative overflow-hidden">
      {/* Background decorations */}
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
        <div className="absolute top-0 right-0 w-[400px] lg:w-[600px] h-[400px] lg:h-[600px] bg-green-50/50 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2" />
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center mb-12 lg:mb-20 max-w-3xl mx-auto">
          ...
          <p className="text-slate-500 text-lg lg:text-xl leading-relaxed font-normal">Ринок змінився, а інструменти — ні. <span className="text-slate-900 font-bold">vezuway</span> пропонує нову екосистему замість хаосу.</p>
        </div>
